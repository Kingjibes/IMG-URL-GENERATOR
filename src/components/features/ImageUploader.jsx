import React, { useState, useCallback } from 'react';
    ...
    import { UploadCloud, Copy, Check, FileCheck2, ImagePlus } from 'lucide-react';
    ...
    const ImageUploader = ({ onUploadSuccess }) => {
      ...
      const handleUpload = useCallback(async () => {
        ...
        try {
          ...
          const uniqueFileName = `${randomString}_${Date.now()}.${fileExt}`;
          ...
          if (onUploadSuccess) {
            onUploadSuccess({ id: uniqueFileName, url: generatedUrl, name: originalFileName, timestamp: Date.now() });
          }
